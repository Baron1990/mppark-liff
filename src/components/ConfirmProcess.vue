<template>
  <div class="container text-monospace" id="app">
    <b-card bg-variant="light" text-variant="black" title="MP 停車場">
      <b-card-text class="mt-5">如果要再次入場，再次點選。</b-card-text>
      <b-button class="btn btn-danger btn-lg btn-block mt-3" @click="enter">我要入場</b-button>
      <b-button class="btn btn-danger btn-lg btn-block mt-3" @click="enter">關閉</b-button>
    </b-card>
  </div>
</template>
